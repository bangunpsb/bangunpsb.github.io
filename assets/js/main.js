...
function scrollFunction() {
  if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
    document.getElementById("site-header").style.backgroundColor = "#373C46";
    var header = document.getElementById("site-header").getElementsByTagName("h1")[0];
    header.style.marginTop = "0vw";
    header.style.transition = "0.5s";

    var nav, i;
    var nav = document.querySelectorAll(".site-nav ul li a");
    for (i = 0; i < nav.length; i++) {
      nav[i].style.marginTop = "0vw";
      nav[i].style.marginBottom = "0vw";
